...
urlpatterns = [
    ...
    path('v2/progress/<int:show_id>/create/', V2ProgressCreateView.as_view(), name='v2_progress_create'),
    path('v2/progress/<int:show_id>/update/', V2ProgressUpdateView.as_view(), name='v2_progress_update'),
