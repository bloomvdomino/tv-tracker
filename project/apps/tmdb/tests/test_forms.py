...
class TestProgressForm:
    ...
    @pytest.mark.parametrize('current_episode,next_episode,next_air_date', [
        ((0, 0), (None, None), None),
        ((0, 0), (1, None), None),
        ((0, 0), (None, 1), None),
    ...
    def test_update_episodes(self, instance, show, get_air_date, current_episode, next_episode, next_air_date):
