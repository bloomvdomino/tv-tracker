...
class TestUserManager:
    ...
    def create_user(self, mocker):
        return mocker.patch('project.apps.accounts.managers.UserManager._create_user')
    ...
    def test_create_user(self, manager, create_user):
        ...
        create_user.assert_called_once_with('u@test.com', '123', is_staff=False, is_superuser=False, foo=123)
    ...
    def test_create_superuser(self, manager, create_user):
        ...
        create_user.assert_called_once_with('u@test.com', '123', is_staff=True, is_superuser=True, foo=123)
